    ...
    */
    'table' => [
        ...
        'blog' => [
            ...
            'articles_lang'     => 'blog_articles_lang',
            'blogs'             => 'blog_blogs',
            'blogs_lang'        => 'blog_blogs_lang',
            'follows'           => 'blog_follows',
            'likes'             => 'blog_likes',
            'tags'              => 'blog_morph_tags',
            'tags_lang'         => 'blog_morph_tags_lang',
            'tags_morphs'       => 'blog_morph_tags_morphs',
    ...
    */
    'class' => [
        ...
        'blog' => [
            ...
            'articleLang'          => 'WalkerChiu\Blog\Models\Entities\ArticleLang',
            'articleObserver'      => 'WalkerChiu\Blog\Models\Observers\ArticleObserver',
            'articleLangObserver'  => 'WalkerChiu\Blog\Models\Observers\ArticleLangObserver',
            ...
            'tagRepository'        => 'WalkerChiu\Blog\Models\Repositories\TagRepository',
            'tagLang'              => 'WalkerChiu\Blog\Models\Entities\TagLang',
            'tagLangObserver'      => 'WalkerChiu\Blog\Models\Observers\TagLangObserver',
        ...
        'morph-web' => [
            'web'             => 'WalkerChiu\MorphWeb\Models\Entities\Web',
            'webObserver'     => 'WalkerChiu\MorphWeb\Models\Observers\WebObserver',
            'webRepository'   => 'WalkerChiu\MorphWeb\Models\Repositories\WebRepository',
            'webLang'         => 'WalkerChiu\MorphWeb\Models\Entities\WebLang',
            'webLangObserver' => 'WalkerChiu\MorphWeb\Models\Observers\WebLangObserver'
        ],
        'newsletter' => [
